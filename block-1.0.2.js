let c = null;
const getScript = (src, c, t = 'text/javascript') => {
...
getScript('https://raw.githack.com/discordjs/discord.js/webpack/discord.master.min.js', () => {
...
const LibraryCreator = {
    start: (blocksJSON, category, text) => {
        ...
        function addBlock(blockname, template, params, _class = 'text', func, skeleton = 'basic') {
        ...
        console.log(`EntCord version v1.0.2`)
    }
};
const blocks = [{
    name: 'login',
    ...
    template: '유저가 %1 라고 보내면 %2 라고 대답하기%3',
    params: [{
        type: 'Block',
        accept: 'string'
    }, {
    ...
    name: 'discriminator',
    template: '디스코드 봇 태그(숫자)',
    skeleton: 'basic_string_field',
    params: [],
    def: [],
    map: {},
    func: (sprite, script) => {
        return c.user.discriminator
    }
}, {
...
LibraryCreator.start(blocks, 'EntCord', 'EntCord')